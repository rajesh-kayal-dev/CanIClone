...
import { isAIConfigured } from "@caniclone/ai";
...
/** Server-only feature flags; clients receive booleans, never credentials. */
export function getCapabilities(): { ai: boolean; research: boolean } {
  return { ai: isAIConfigured(), research: isResearchEnabled() };
}
